  ...
  return (
    <div>
      <ol className='breadcrumb float-xl-end'>
        ...
        <li className='breadcrumb-item active'>5th Leg Details</li>
      </ol>
      <h1 className='page-header'>5th Leg Details</h1>
      <Panel>
        <PanelHeader>
          5th Leg MCC invitational STANDARD OPEN Training games with prizes - (Oct. 21-22, 2023 at G/F, Starmall Edsa Shaw, Mandaluyong City)
        </PanelHeader>
        <PanelBody>
          <ol>
            <li>
            ...
            <li>
              ...
              <ol type='a'>
                <li>Deadline is set on October 18.</li>
