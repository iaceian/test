...
function Leg2Details() {
  return (
    <div>
      ...
      <Panel>
        <PanelHeader>
          2nd Leg MCC invitational STANDARD OPEN Training games with prizes - (June 24-25, 2023 at G/F, Starmall Edsa Shaw, Mandaluyong City)
        </PanelHeader>
        <PanelBody>
          <ol>
            <li>
            ...
            <li>
              ...
              <ol type='a'>
                <li>Deadline is set on June 21.</li>
                    ...
                    <table className='table mb-0'>
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>Juniors (male/female);</td>
                          <td>and Kiddies -12 & below (boy/girl)</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
